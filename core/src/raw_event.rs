...
use crate::{CanonicalEvent, EventId, EventSignature, Pubkey, Seckey};
...
impl RawEvent {
    ...
    pub fn sign(&mut self, seckey: &Seckey) {
        ...
        self.sig = EventSignature::new(signature.to_bytes());
    }
}
